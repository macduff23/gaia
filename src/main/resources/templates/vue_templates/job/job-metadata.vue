<template id="job-metadata-template">
    <div class="job-metadata-container" :class="job.status">
        ...
        <div class="job-actions">
            <b-button variant="info" size="lg" v-if="isRetryAvailable" @click="$emit('retry')"><i class="fas fa-redo"></i> Retry</b-button>
            <b-button variant="danger" size="lg" v-if="isDeleteAvailable" @click="$emit('delete')"><i class="far fa-trash-alt"></i> Delete</b-button>
        </div>
    </div>
</template>
